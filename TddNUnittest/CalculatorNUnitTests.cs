...
namespace TddNUnittest
{
    ...
    public class CalculatorNUnitTests
    {
        ...
        {
            Calculator calc = new();
            bool isOdd = calc.IsOddNumber(12);
        ...
        public void AddNumbersDouble_InputTwoDouble_GetCorrectAddition(double a, double b)
        {
            ...
            //Assert
            ClassicAssert.AreEqual(15.9, result, .5); //for double I guess.5 is a delta value which will give 
            //arange of correct answer brtween 15.4 and 16.4
